.TH _PRINTF 3 "november 13 2023" "0.1" "ALX  - _printf"
...
directives: ordinary characters (not \fB%\fR) which are copied unchanged to the output stream; and conversion specifications, each of which results in
...
or unsigned hexadecimal (\fBx\fR and \fBX\fR)
...
#include <limits.h>
/**
* main - this is the main function in use
* Return: returns void
*/
int main(void)
...
.SH AUTHOR Christopher Ekom and Philemon S.P
