 ...
 * Return: Number of chars printed.
 */
int write_fnumb1(int negative, int ind, char lim[],
	int flags, int width, int precision, int size)
{
	...
	return (write_fnum1(ind, lim, flags, width, precision,
		length, padd, extra_ch));
}

/**
 * write_fnum1 - Write a number using a bufffer
 ...
 */
int write_fnum1(int ind, char lim[],
...
/**
 * write_u1 - Writes an unsigned number
 ...
 */
int write_u1(int negative, int ind,
	char lim[],
	int flags, int width, int precision, int size)
{
...
/**
 * write_p1 - Write a memory address
 * @lim: Arrays of chars
 * @ind: Index at which the number starts in the lim
 ...
 * Return: Number of written chars.
 */
int write_p1(char lim[], int ind, int length,
