...
/**
 * check_flags3 - Calculates active flags
 * @fstr: Formatted string in which to print the arguments
 * @i: take a parameter.
 * Return: Flags:
 */
int check_flags3(const char *fstr, int *i)
{
	/* - + 0 # ' ' */
	/* 1 2 4 8  16 */
	int j, curr_i;
...
/**
 * check_width2 - Calculates the width for printing
 * @fstr: Formatted string in which to print the arguments.
 * @i: List of arguments to be printed.
 * @fargs: list of arguments.
 *
 * Return: width.
 */
int check_width2(const char *fstr, int *i, va_list fargs)
{
	int curr_i;
	int width = 0;
